...
export default function AgentsPage() {
  ...
  return (
    <div className="flex h-screen">
      <Sidebar />
      <div className="flex-1 p-4 md:p-8 pt-14 md:pt-8 overflow-y-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {agents.map((agent) => (
                <button
                  ...
                  className="bg-white rounded-xl border p-6 text-left hover:shadow-md hover:border-blue-200 transition-all text-left"
                >
