      ...
      >
        ...
        <div className="px-3 py-2 shrink-0">
          <div className="relative">
            <Search
              ...
              style={{ width: 14, height: 14, color: 'var(--c-text-tertiary)' }}
            />
            <input
              value={search}
        ...
        <div className="flex-1 overflow-y-auto overflow-x-hidden px-2 space-y-0.5">
          {filtered.length === 0 && search ? (
            <p
              className="text-xs text-center py-8 animate-fade-in"
              style={{ color: 'var(--c-text-tertiary)' }}
            >
              未找到匹配的对话
            </p>
            ...
            <div className="flex flex-col items-center justify-center py-12 text-center animate-fade-in">
              <MessageSquare
                ...
                style={{ color: 'var(--c-text-tertiary)', opacity: 0.4 }}
              />
              <p className="text-xs mb-2" style={{ color: 'var(--c-text-tertiary)' }}>
                暂无对话
              </p>
              <button
                onClick={() => {
            ...
            filtered.map((conv, idx) => (
              ...
              >
                <button
                  ...
                  style={{
                    color:
                      currentConvId === conv.id ? 'var(--c-primary)' : 'var(--c-text-secondary)',
